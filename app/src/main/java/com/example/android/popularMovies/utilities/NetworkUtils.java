...
public final class NetworkUtils {
    ...
    public static String buildUrl(String searchCriteria, Context context)
    {

        Uri uri = Uri.parse(MOVIE_DB_BASE_URL).buildUpon()
                .appendEncodedPath(searchCriteria)
                .appendQueryParameter(KEY_PARAM_API, context.getString(R.string.MOVIE_DB_API_KEY))
                .build();
    ...
    public static String buildExtraInfoUri(int movieId, String action, Context context)
    {
       Uri retUri = null;
